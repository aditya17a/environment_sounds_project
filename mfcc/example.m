...
%   Author: Kamil Wojcicki, September 2011
    ...
    HF = 1500;              % upper frequency limit (Hz)
    %wav_file = 'sp10.wav';  % input audio filename
    
    wav_file = 'data/train/train198.aiff';
    %wav_file = 'San Francisco Fire Department @ Jones St & Post St San Francisco California.mp3';
    % Read speech samples, sampling rate and precision from file

    % Read speech samples, sampling rate and precision from file
    [ speech, fs] = audioread( wav_file );
    wav_file = mean(wav_file, 2);
